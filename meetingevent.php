...
$sql = "SELECT d.meetingevents_image, d.meetingevents_image_enabled, d.meetingevents_clip, d.meetingevents_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . MEETINGEVENTS_TABLE . " d 
    JOIN " . MEETINGEVENT_TRANSLATIONS_TABLE . " t ON t.meetingevents_id = d.meetingevents_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.meetingevents_enabled = 1  
    ORDER BY d.meetingevents_order";
...
{
    $fitness_data[$i] = array(
	'rec1'			=> $rec1,
	'image'			=> $row['meetingevents_image'],
	'image_enable'	=> $row['meetingevents_image_enabled'],
	'clip'			=> $row['meetingevents_clip'],
	'clip_enable'	=> $row['meetingevents_clip_enabled'],
	'title'			=> $row['title'],
...
$template->assign_vars(array(
	...
	'S_CONTENT'		=> prepare_message($fitness_data[0]['description']),
