...
$sql = "SELECT d.forgets_image, d.forgets_image_enabled, d.forgets_clip, d.forgets_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . FORGETS_TABLE . " d 
    JOIN " . FORGET_TRANSLATIONS_TABLE . " t ON t.forgets_id = d.forgets_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.forgets_enabled = 1  
    ORDER BY d.forgets_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['forgets_image'],
	'image_enable'	=> $row['forgets_image_enabled'],
	'clip'			=> $row['forgets_clip'],
	'clip_enable'	=> $row['forgets_clip_enabled'],
	'title'			=> $row['title'],
