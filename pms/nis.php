...
switch( $event )
{
    ...
    case $pms_event['occupancy_by_date_check']:  // VHP
    
	$success = $pms->occupancy_request_check($code);
	break;

    case $pms_event['occupancy_by_date']:  // VHP
    
	$success = $pms->occupancy_date_send($code);
	break;
}
