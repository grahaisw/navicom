...
$sql = "SELECT d.massage_image, d.massage_image_enabled, d.massage_clip, d.massage_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . MASSAGES_TABLE . " d 
    JOIN " . MASSAGE_TRANSLATIONS_TABLE . " t ON t.massage_id = d.massage_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.massage_enabled = 1  
    ORDER BY d.massage_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['massage_image'],
	'image_enable'	=> $row['massage_image_enabled'],
	'clip'			=> $row['massage_clip'],
	'clip_enable'	=> $row['massage_clip_enabled'],
	'title'			=> $row['title'],
