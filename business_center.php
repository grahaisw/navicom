...
$sql = "SELECT d.business_centers_image, d.business_centers_image_enabled, d.business_centers_clip, d.business_centers_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . BUSINESS_CENTERS_TABLE . " d 
    JOIN " . BUSINESS_CENTER_TRANSLATIONS_TABLE . " t ON t.business_centers_id = d.business_centers_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.business_centers_enabled = 1  
    ORDER BY d.business_centers_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['business_centers_image'],
	'image_enable'	=> $row['business_centers_image_enabled'],
	'clip'			=> $row['business_centers_clip'],
	'clip_enable'	=> $row['business_centers_clip_enabled'],
	'title'			=> $row['title'],
