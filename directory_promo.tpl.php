<?php if (!defined('IN_TONJAW')) exit; $this->_tpl_include('header.tpl'); ?><!-- it works the same with all jquery version from 1.3.1 to 2.0.3 --><!-- use jssor.slider.mini.js (39KB) or jssor.sliderc.mini.js (31KB, with caption, no slideshow) or jssor.sliders.mini.js (26KB, no caption, no slideshow) instead for release --><!-- jssor.slider.mini.js = jssor.sliderc.mini.js = jssor.sliders.mini.js = (jssor.core.js + jssor.utils.js + jssor.slider.js) -->
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider2.$SetScaleWidth(Math.min(parentWidth, 1250));
                else
    ...
    <div id="slider2_container" style="position: absolute; top: 40px; right: 20px; width: 1250px; 
        height: 650px; overflow: hidden;">

       

        <!-- Slides Container -->
       <div u="slides" style="cursor: move; position: absolute; right: 42px; top: -20px; width: 803px; height: 540px;
            overflow: hidden; background: #000;">
            <?php $_directory_promo_count = (isset($this->_tpldata['directory_promo'])) ? sizeof($this->_tpldata['directory_promo']) : 0;if ($_directory_promo_count) {for ($_directory_promo_i = 0; $_directory_promo_i < $_directory_promo_count; ++$_directory_promo_i){$_directory_promo_val = &$this->_tpldata['directory_promo'][$_directory_promo_i]; ?>

            <div>
                <img u=image src="<?php echo (isset($this->_rootref['T_MEDIA_IMAGE_PATH'])) ? $this->_rootref['T_MEDIA_IMAGE_PATH'] : ''; ?>800x485/<?php echo $_directory_promo_val['S_IMAGE']; ?>"/>
                <div u="thumb"><h2><!--<?php echo $_directory_promo_val['S_TITLE']; ?>--></h2>
		    <span class="sub_container"><!--<?php echo $_directory_promo_val['S_CONTENT']; ?>--><span>
                </div>
            </div>
            <?php }} ?>
        ...
        <div u="thumbnavigator" class="slider2-T" style="position: absolute; top: 132px; left: 61px; width:500px; height:470px; text-align: right;">
            <div style="filter: alpha(opacity=60); opacity:0; position: absolute; display: block;
	...
	src: url(<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/myriadpro.otf);
    }
    .dir_slider img{
