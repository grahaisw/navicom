...
$sql = "SELECT d.contactus_image, d.contactus_image_enabled, d.contactus_clip, d.contactus_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . CONTACTUS_TABLE . " d 
    JOIN " . CONTACTUS_TRANSLATIONS_TABLE . " t ON t.contactus_id = d.contactus_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.contactus_enabled = 1  
    ORDER BY d.contactus_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['contactus_image'],
	'image_enable'	=> $row['contactus_image_enabled'],
	'clip'			=> $row['contactus_clip'],
	'clip_enable'	=> $row['contactus_clip_enabled'],
	'title'			=> $row['title'],
