<?php if (!defined('IN_TONJAW')) exit; $this->_tpl_include('admin_header.tpl'); ?>
			...
			<tr>
			    <td><label for="value"><?php echo ((isset($this->_rootref['L_VALUE'])) ? $this->_rootref['L_VALUE'] : ((isset($user->lang['VALUE'])) ? $user->lang['VALUE'] : '{ VALUE }')); ?>:</label></td>
			    <td><input type="text" name="value" class="inputbox autowidth"  value="<?php echo (isset($this->_rootref['S_VALUE'])) ? $this->_rootref['S_VALUE'] : ''; ?>"></td>
			</tr>
			<tr>
