...
{
    $pms->pms_sync();
    //$next_url = append_sid("{$tonjaw_admin_path}pms_sync.$phpEx") . '&amp;mode=sync';
...
$template->assign_vars(array(
    ...
    'L_CONFIRM_SYNC'		=> $adm_lang['confirm_sync'],
    'U_ACTION'			=> append_sid("{$tonjaw_admin_path}pms_sync.$phpEx") . '&amp;mode=sync',
