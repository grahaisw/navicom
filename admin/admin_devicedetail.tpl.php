<?php if (!defined('IN_TONJAW')) exit; $this->_tpl_include('admin_header.tpl'); ?>
	...
	<tr>
	    <td><label for="file"><?php echo ((isset($this->_rootref['L_DEVICE_ID'])) ? $this->_rootref['L_DEVICE_ID'] : ((isset($user->lang['DEVICE_ID'])) ? $user->lang['DEVICE_ID'] : '{ DEVICE_ID }')); ?></label></td>
	    <td><input name="device" type="text" id="file" value="<?php echo (isset($this->_rootref['S_DEVICE'])) ? $this->_rootref['S_DEVICE'] : ''; ?>" /></td>
	</tr>
	
	<tr>
	    <td><label for="node_id"><?php echo ((isset($this->_rootref['L_NODE'])) ? $this->_rootref['L_NODE'] : ((isset($user->lang['NODE'])) ? $user->lang['NODE'] : '{ NODE }')); ?></label></td>
	    <td><?php echo (isset($this->_rootref['S_CATEGORY'])) ? $this->_rootref['S_CATEGORY'] : ''; ?></td>
	</tr>
	<tr>
	    <td><label for="enabled"><?php echo ((isset($this->_rootref['L_DEVICE_ON'])) ? $this->_rootref['L_DEVICE_ON'] : ((isset($user->lang['DEVICE_ON'])) ? $user->lang['DEVICE_ON'] : '{ DEVICE_ON }')); ?></label></td>
	    <td><input id="status" name="status" type="checkbox" class="radio" <?php echo (isset($this->_rootref['V_STATUS'])) ? $this->_rootref['V_STATUS'] : ''; ?>/><label>&nbsp;</label></td>
	</tr>
	<tr>
