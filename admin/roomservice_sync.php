...
//print_r( $hotel_info ); echo '<br/>';
//print_r( $pms_info ); echo '<br/>';
...
$template->assign_vars(array(
    ...
    'L_SUBMIT'			=> $adm_lang['sync'],
    'L_CONFIRM_SYNC'		=> $adm_lang['confirm_roomservice_sync'],
    'U_ACTION'			=> append_sid("{$tonjaw_admin_path}roomservice_sync.$phpEx") . '&amp;mode=sync',
...
$template->set_filenames(array(
	'body' => 'admin_roomservice_sync.tpl',
));
