...
$(function() {
    $('#DeleteLink').click(function() {
        return confirm('<?php echo ((isset($this->_rootref['L_CONFIRM_DELETE'])) ? $this->_rootref['L_CONFIRM_DELETE'] : ((isset($user->lang['CONFIRM_DELETE'])) ? $user->lang['CONFIRM_DELETE'] : '{ CONFIRM_DELETE }')); ?>');
			...
			<tr>
			    <td><label for="url"><?php echo ((isset($this->_rootref['L_URL'])) ? $this->_rootref['L_URL'] : ((isset($user->lang['URL'])) ? $user->lang['URL'] : '{ URL }')); ?>:</label></td>
			    <td><input id="url" name="url" type="text" value="<?php echo (isset($this->_rootref['S_URL'])) ? $this->_rootref['S_URL'] : ''; ?>"/></td>
			</tr>
			<tr>
		...
		<?php } if ($this->_rootref['S_DETAIL']) {  if ($this->_rootref['S_ADD_UPDATE']) {  ?>
			...
			<tr>
			    <td><label for="url"><?php echo ((isset($this->_rootref['L_URL'])) ? $this->_rootref['L_URL'] : ((isset($user->lang['URL'])) ? $user->lang['URL'] : '{ URL }')); ?>:</label></td>
			    <td><label><?php echo (isset($this->_rootref['S_URL'])) ? $this->_rootref['S_URL'] : ''; ?></label></td>
			</tr>
			<tr>
			    <td><label for="genre"><?php echo ((isset($this->_rootref['L_GROUP'])) ? $this->_rootref['L_GROUP'] : ((isset($user->lang['GROUP'])) ? $user->lang['GROUP'] : '{ GROUP }')); ?>:</label></td>
			    <td><?php echo (isset($this->_rootref['S_GROUP'])) ? $this->_rootref['S_GROUP'] : ''; ?></td>
