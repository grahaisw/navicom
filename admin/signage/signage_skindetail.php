...
/**
*
* admin/signage/signage_skindetail.php
*
...
if (isset($_POST['submit']))
{
    ...
    $sql_ary = array(
		'template_name'		=> (string) $style_name,
		'template_description'	=> (string) $style_description,
		'template_enabled'		=> (int) $style_active,
    );
...
if ($mode === 'update')
{
	...
	$sql = 'SELECT * FROM ' . SIGNAGE_TEMPLATES_TABLE . " WHERE template_id=" . (int) $style_id;
...
$template->assign_vars(array(
    ...
    'U_ACTION'		=> append_sid("{$tonjaw_admin_signage_path}signage_skindetail.$phpEx"),
    ...
    'V_ACTIVE'		=> ($data['template_enabled'])? 'checked' : '',
    'S_FORM_TOKEN'	=> $s_hidden_fields,
    'L_LABEL'			=> $label,
 ));

$template->set_filenames(array(
	'body' => 'admin_signage_skinform.tpl',
));
