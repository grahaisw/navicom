<?php if (!defined('IN_TONJAW')) exit; $this->_tpl_include('admin_header.tpl'); ?>
			...
			<tr>
			    ...
			    <td width="85%"><input name="name" type="text" value="<?php echo (isset($this->_rootref['S_NAME'])) ? $this->_rootref['S_NAME'] : ''; ?>" size="60"/>
			    </td>
			</tr>
			...
			<tr>
			    <td><label for="node"><?php echo ((isset($this->_rootref['L_NODE'])) ? $this->_rootref['L_NODE'] : ((isset($user->lang['NODE'])) ? $user->lang['NODE'] : '{ NODE }')); ?>:</label></td>
