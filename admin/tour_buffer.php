...
$u_action = append_sid("{$tonjaw_admin_path}tour_buffer.$phpEx", "mode=update");
...
$start = view_indirect_buffers($buffer_data, $buffer_count, $config['tour_buffer_type']);
...
foreach ($buffer_data as $row)
{
	...
	'U_UPDATE'		=> append_sid("{$tonjaw_admin_path}tour_buffer.$phpEx", "mode=update") . '&amp;id=' . $row['id'] . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
	...
	'U_DECLINED'		=> append_sid("{$tonjaw_admin_path}tour_buffer.$phpEx", "mode=decline") . '&amp;id=' . $row['id'] . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
	'DECLINED'		=> $declined,
	'U_RECEIVED'		=> append_sid("{$tonjaw_admin_path}tour_buffer.$phpEx", "mode=approve") . '&amp;id=' . $row['id'] . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
	'U_DELETE'		=> append_sid("{$tonjaw_admin_path}tour_buffer.$phpEx", "mode=delete") . '&amp;id=' . $row['id'] . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
...
$template->assign_vars(array(
    ...
    'L_DELETE'			=> $adm_lang['delete'],
    'L_CAR_TERAPHIST'		=> $adm_lang['transportation'],
