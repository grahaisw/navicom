    ...
    $('#DeleteLink').click(function() {
		...
		<?php if ($this->_rootref['S_FORM']) {  ?>
			...
			<tr>
			    ...
			    <td width="85%"><input type="text" name="title" value="<?php echo (isset($this->_rootref['S_TITLE'])) ? $this->_rootref['S_TITLE'] : ''; ?>" size="69"></td>
			</tr>
			<tr>
			...
			<tr>
			    ...
			    <td><input name="image" type="text" value="<?php echo (isset($this->_rootref['S_IMAGE'])) ? $this->_rootref['S_IMAGE'] : ''; ?>"/></td>
			</tr>
			<tr>
