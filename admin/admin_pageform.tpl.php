    ...
    $('#DeleteLink').click(function() {
		...
		<?php if ($this->_rootref['S_FORM']) {  ?>
			...
			<tr>
			    ...
			    <td><input type="text" name="upload_thumbnail" id="upload_thumbnail" class="inputbox autowidth"  value="<?php echo (isset($this->_rootref['S_THUMBNAIL'])) ? $this->_rootref['S_THUMBNAIL'] : ''; ?>"></td>
			</tr>
			...
			<tr>
			    ...
			    <td><input name="clip" type="text" id="clip" size="100" value="<?php echo (isset($this->_rootref['S_CLIP'])) ? $this->_rootref['S_CLIP'] : ''; ?>" /><br/>
			...
			<tr>
			    <td><label for="in_menu"><?php echo ((isset($this->_rootref['L_IN_MENU'])) ? $this->_rootref['L_IN_MENU'] : ((isset($user->lang['IN_MENU'])) ? $user->lang['IN_MENU'] : '{ IN_MENU }')); ?>:</label></td>
			    <td><input id="in_menu" name="in_menu_flag" type="checkbox" class="radio" <?php echo (isset($this->_rootref['V_IN_MENU'])) ? $this->_rootref['V_IN_MENU'] : ''; ?>/><label>&nbsp;</label></td>
			</tr>
			<tr>
			    ...
			    <td><input id="allow_ads" name="allow_ads_flag" type="checkbox" class="radio" <?php echo (isset($this->_rootref['V_ALLOW_ADS'])) ? $this->_rootref['V_ALLOW_ADS'] : ''; ?>/><label>&nbsp;</label></td>
			</tr>
			<tr>
		...
		<?php } if ($this->_rootref['S_DETAIL']) {  if ($this->_rootref['S_ADD_UPDATE']) {  ?>
			...
			<tr>
			    <td><label for="in_menu"><?php echo ((isset($this->_rootref['L_IN_MENU'])) ? $this->_rootref['L_IN_MENU'] : ((isset($user->lang['IN_MENU'])) ? $user->lang['IN_MENU'] : '{ IN_MENU }')); ?>:</label></td>
			    <td><label><?php echo (isset($this->_rootref['S_IN_MENU'])) ? $this->_rootref['S_IN_MENU'] : ''; ?>:</label></td>
			</tr>
			<tr>
			    <td><label for="allow_ads"><?php echo ((isset($this->_rootref['L_ALLOW_ADS'])) ? $this->_rootref['L_ALLOW_ADS'] : ((isset($user->lang['ALLOW_ADS'])) ? $user->lang['ALLOW_ADS'] : '{ ALLOW_ADS }')); ?>:</label></td>
			    <td><?php echo (isset($this->_rootref['S_ALLOW_ADS'])) ? $this->_rootref['S_ALLOW_ADS'] : ''; ?>:</label></td>
			</tr>
			<tr>
