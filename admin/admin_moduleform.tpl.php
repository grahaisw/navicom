<?php if (!defined('IN_TONJAW')) exit; $this->_tpl_include('admin_header.tpl'); ?>
	...
	<tr>
	    ...
	    <td><input name="order" type="text" id="order" value="<?php echo (isset($this->_rootref['S_ORDER'])) ? $this->_rootref['S_ORDER'] : ''; ?>" maxlength="2" /></td>
	</tr>
	<tr>
	    <td><label for="in_admin"><?php echo ((isset($this->_rootref['L_IN_ADMIN'])) ? $this->_rootref['L_IN_ADMIN'] : ((isset($user->lang['IN_ADMIN'])) ? $user->lang['IN_ADMIN'] : '{ IN_ADMIN }')); ?>:</label></td>
	    <td><input id="in_admin" name="in_admin_flag" type="checkbox" class="radio" <?php echo (isset($this->_rootref['V_IN_ADMIN'])) ? $this->_rootref['V_IN_ADMIN'] : ''; ?>/><label>&nbsp;</label></td>
	</tr>
	<tr>
	...
	<tbody>
	    ...
	    <tr>
		<td><?php echo ((isset($this->_rootref['L_IN_ADMIN'])) ? $this->_rootref['L_IN_ADMIN'] : ((isset($user->lang['IN_ADMIN'])) ? $user->lang['IN_ADMIN'] : '{ IN_ADMIN }')); ?></td>
		<td>:<?php echo (isset($this->_rootref['S_IN_ADMIN'])) ? $this->_rootref['S_IN_ADMIN'] : ''; ?></td>
	    </tr>
	    <tr>
