<?php if (!defined('IN_TONJAW')) exit; $this->_tpl_include('admin_header.tpl'); ?>
		...
		<?php if ($this->_rootref['S_FORM']) {  ?>
			...
			<tr>
			    ...
			    <td><input name="nomor" type="text" value="<?php echo (isset($this->_rootref['S_NOMOR'])) ? $this->_rootref['S_NOMOR'] : ''; ?>" size="60"/></td>
			</tr>
		...
		<?php } if ($this->_rootref['S_DETAIL']) {  if ($this->_rootref['S_ADD_UPDATE']) {  ?>
			...
			<tr>
			    <td><label><?php echo ((isset($this->_rootref['L_NOMOR'])) ? $this->_rootref['L_NOMOR'] : ((isset($user->lang['NOMOR'])) ? $user->lang['NOMOR'] : '{ NOMOR }')); ?>:</label></td>
			    <td><?php echo (isset($this->_rootref['S_NOMOR'])) ? $this->_rootref['S_NOMOR'] : ''; ?></td>
			</tr>
