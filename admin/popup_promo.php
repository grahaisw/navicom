...
$u_action = append_sid("{$tonjaw_admin_path}popup_promo.$phpEx", "mode=update");

//GRAB SERVICE POPUP DATA
$popup_data = array();
$popup_count = 0;
//$sql_sort = 'log_time DESC';
$start = view_popups($popup_data, $popup_count);
...
foreach ($popup_data as $row)
{
	...
	'U_UPDATE'		=> append_sid("{$tonjaw_admin_path}popup_promodetail.$phpEx", "mode=update") . '&amp;id=' . $row['id'] . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
	'L_UPDATE'		=> $adm_lang['edit'],
	'U_DELETE'		=> append_sid("{$tonjaw_admin_path}popup_promo.$phpEx", "mode=delete") . '&amp;id=' . $row['id'] . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
...
$template->assign_vars(array(
    ...
    'U_ADD'			=> append_sid("{$tonjaw_admin_path}popup_promodetail.$phpEx", "mode=add") . '&amp;parent=' . $file[0] . '&amp;module=' . $module->active_module_name,
    'L_ADD'			=> $adm_lang['add'],
    'S_FACEBOX'			=> '0',
    'S_DATATABLE_NODES'		=> '1',
    'S_FOURTH_FIELD'		=> '1',
