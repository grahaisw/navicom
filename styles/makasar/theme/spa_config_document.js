...
media.handler = function (e) {
    ...
    switch (key) {
		...
		$.fancybox.open({
			href : 'spa_confirm.php?code=' + channelListArray[media.channelIndex][8] + 
	...
	'&title=' + channelListArray[media.channelIndex][0],
        ...
        /*case keyCodes.KEY_blue:
			$.fancybox.open({
			href : 'basket_custom1.php?mode=view&type=S' ,
			type : 'iframe',
			padding : 5
		});
			break;*/
...
media.JS_FullScreen_Function = function () {
    window.location='spa.php?code='  + channelListArray[media.channelIndex][8] + 
	'&qty=' + channelListArray[media.channelIndex][9] + 
	'&item_id=' + channelListArray[media.channelIndex][12] + 
	'&price=' + channelListArray[media.channelIndex][7] +
	'&gid=' + channelListArray[media.channelIndex][13] + 
