...
var init = function() {
    ...
    media.video = doc.getElementById("HomeClip");
...
media.handler = function(e) {
    ...
    switch (key) {
        ...
        case keyCodes.KEY_enter:
			...
			//$("#mode").val("fullscreen");
			//var gid = $("#gid").val();
			//location.href= 'tv_channel_fullscreenlg.php?ch=' + channelListArray[media.channelIndex][5] + '&gid=' + gid;
	...
	case keyCodes.KEY_vod:
        ...
        case keyCodes.KEY_9:
            e.preventDefault();
            media.JS_ChannelSwitchByIndex(key);
            break;
    };
};
...
media.JS_FullScreen_Function = function() {
	...
	var mode = $("#mode").val();
	if(mode == "preview") $("#mode").val("fullscreen");
	else { $("#mode").val("preview"); hidePopupPromo(); }
