...
media.handler = function (e) {
    ...
    switch (key) {
        ...
        case keyCodes.KEY_enter:
			//location.href= 'tv_full.php?ch=' + channelListArray[media.channelIndex][4];
            var gid = $("#gid").val();
            location.href= 'tv_full.php?gid='+gid+'&ch=' + channelListArray[media.channelIndex][5];
...
media.JS_ChannelSwitchByOrder = function(key) { console.log(key);
    clearTimeout(media.TimerEntry); 
