...
mediaPlayer.prototype.Fn_PlayLoadSRC = function (sucess) {
    try {
		...
		$("#divPicture").html("<img src='" + channelListArray[media.channelIndex][5] + "'>");
		$("#divGradPicture").html("<img src='" + channelListArray[media.channelIndex][6] + "'>");	
        $("#divCurrentChannelDescFullScreen").html(channelListArray[media.channelIndex][2]);
		$("#divDescription").html(channelListArray[media.channelIndex][2]);
