...
mediaPlayer.prototype.scrolltop = parseFloat(390 / (channelListArray.length - 1));
...
mediaPlayer.prototype.initCreate = function () {
    ...
    for (var i = 0; i < media.channelObjlen; i++) {
        if (i == 0) {
            _div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='divChannelItems channelFocus' ><span class='spanChannlItem'>" + channelListArray[i][0] + "</span><span class='spanChannlItem2'>" + channelListArray[i][1] + "</span><span class='spanChannlItem3'>" + channelListArray[i][2] + "</span></div>";
        } else {
            _div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='divChannelItems' ><span class='spanChannlItem'>" + channelListArray[i][0] + "</span><span class='spanChannlItem2'>" + channelListArray[i][1] + "</span><span class='spanChannlItem3'>" + channelListArray[i][2] + "</span></div>";
        };
    };
...
mediaPlayer.prototype.Fn_ChannelListDataBind = function (val) {
    for (var i = 0; i < media.channelObjlen; i++) {
        if (channelListArray[i + val] != undefined) {
            $(media.channelListObject[i]).attr("cItem", (i + val)).html("<span class='spanChannlItem'>" + channelListArray[i + val][0] + "</span><span class='spanChannlItem2'>" + channelListArray[i + val][1] + "</span><span class='spanChannlItem3'>" + channelListArray[i + val][2] + "</span>");
        } else {
