...
mediaPlayer.prototype.Fn_PlayLoadSRC = function (sucess) {
	...
	$("#divDescription").html(channelListArray[media.channelIndex][2] + "<br>" + channelListArray[media.channelIndex][15]);
	$("#divPrice").html(channelListArray[media.channelIndex][11] + ": " + channelListArray[media.channelIndex][7] + " " + channelListArray[media.channelIndex][10]);
        $(media.mediaPlayIcon).addClass("displayNone");
        $("#divErrorMsg").hide();
        $("#divLoading").removeClass("displayNone");
	$("a").prop("href", "roomservice_confirm.php?code="  + channelListArray[media.channelIndex][8] + 
	'&qty=' + channelListArray[media.channelIndex][9] + 
	'&item_id=' + channelListArray[media.channelIndex][12] + 
	'&price=' + channelListArray[media.channelIndex][7] +
	'&gid=' + channelListArray[media.channelIndex][13] + 
	'&mode=' + channelListArray[media.channelIndex][14] +
    '&title=' + channelListArray[media.channelIndex][0]);
