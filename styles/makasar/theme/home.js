...
mediaPlayer.prototype.initCreate = function () {
    media.channelObjlen = (media._object.channelListLength > 10) ? 10 : media._object.channelListLength;
    var _div = "";
    for (var i = 0; i < media.channelObjlen; i++) {
        if (i == 0) {
            _div += "<img id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='channelFocus spanChannlItem divChannelItems' src='" + channelListArray[i][4] + "' width=120>";
        } else {
            _div += "<img id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='spanChannlItem divChannelItems' src='" + channelListArray[i][4] + "' width=120>";
        };
    };
...
/* Channel List Initial creation */
mediaPlayer.prototype.initCreate = function () {
    media.channelObjlen = (media._object.channelListLength > 9) ? 9 : media._object.channelListLength;
    var _div = "";
    for (var i = 0; i < media.channelObjlen; i++) {
        if (i == 0) {
            _div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='channelFocus spanChannlItem divChannelItems' ><img src='" + channelListArray[i][4] + "' width='136px' ><div id='Title' class='divChannelTitle divChannelTitleFocus'>" + channelListArray[i][0] + "</div></div>";
        } else {
            _div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='spanChannlItem divChannelItems' ><img src='" + channelListArray[i][4] + "' width='136px' ><div id='Title' class='divChannelTitle divChannelTitleFocus'>" + channelListArray[i][0] + "</div></div>";
        };
    };
    $(media.channelListObj).html(_div);
    for (var i = 0; i < media.channelObjlen; i++) {
...
/* Channel List Initial creation */
/*mediaPlayer.prototype.initCreate = function () {
    media.channelObjlen = (media._object.channelListLength > 4) ? 4 : media._object.channelListLength;
    var _div = "";
    for (var i = 0; i < media.channelObjlen; i++) {
        if (i == 0) {
            //_div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='divChannelItems channelFocus' ><span class='spanChannlItem'>" + channelListArray[i][0] + "</span></div>";
			//$(media.channelListObject[i]).attr("cItem", (i + val)).html("<img src='images/icon/alegro.png'>");
			_div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='divChannelItems channelFocus' ><span class='spanChannlItem'><img src='" + channelListArray[i][4] + "'></span></div>";
			
        } else {
            //_div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='divChannelItems' ><span class='spanChannlItem'>" + channelListArray[i][0] + "</span></div>";
			_div += "<div id='divChannelListItem_" + i + "' cItem='" + i + "' onmouseover='media.JS_MouseOverFunction(this," + i + ")' class='divChannelItems' ><span class='spanChannlItem'><img src='" + channelListArray[i][4] + "'></span></div>";
        };
    };
    $(media.channelListObj).html(_div);
    for (var i = 0; i < media.channelObjlen; i++) {
...
mediaPlayer.prototype.Fn_Left_KeyDownHandler = function () {
    ...
    if (media.controlIndex > 0) {
        ...
        var inc = media.channelIndex - (media.channelIndex % 9);
...
mediaPlayer.prototype.Fn_Right_KeyDownHandler = function (handler) {
    ...
    if (media.controlIndex > 0) {
        ...
        media.channelIndex = (media.channelIndex == media._object.channelListLength - 1) ? 0 : media.channelIndex + 1; console.log(media.channelIndex);
        media._object.Fn_Focus_NonFocus();
...
mediaPlayer.prototype.Fn_ChannelListDataBind = function (val) {
    for (var i = 0; i < media.channelObjlen; i++) {
        if (channelListArray[i + val] != undefined) {
            $(media.channelListObject[i]).attr("cItem", (i + val)).html("<img src='" + channelListArray[i + val][4] + "' width='136px' ><div id='Title' class='divChannelTitle divChannelTitleFocus'>" + channelListArray[i + val][0] + "</div>");
        } else {
