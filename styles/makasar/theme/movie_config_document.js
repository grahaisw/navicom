...
var init = function () {
    ...
    media.video = doc.getElementById("media2");
...
media.JS_FullScreen_Function = function () {
    ...
    $("#divChannelList").toggleClass("displayNone");
...
*/
    if (channelListArray[media.channelIndex][4] == 21) {
	    $("#divChannelScrambledBground,#divChannelScrambled").toggleClass("displayNone");
	} else {
	...
	/*window.location='vod.php?code='  + channelListArray[media.channelIndex][16] + 
	'&qty=' + channelListArray[media.channelIndex][17] + 
	'&item_id=' + channelListArray[media.channelIndex][6] + 
	'&price=' + channelListArray[media.channelIndex][14];
	*/
};
