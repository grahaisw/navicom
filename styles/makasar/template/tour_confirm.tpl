...
<style type="text/css">
  ...
  h1 { font-size: 30px; font-family: {S_USER_LANG}; font-weight: bold; margin: 10px; }
  .box { width:350px; }
...
<body>
<h1 style="font-family: {S_USER_LANG};">{L_CONFIRMATION}</h1>
<div>
...
<table style="font-size: 20px; padding: 10px;">
    ...
    <tr>
	<td align="right">{L_TRANSPORTATION}</td>
	<td>{S_TRANSPORTATION}</td>
    </tr>
    <tr>
