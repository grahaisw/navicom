<!-- INCLUDE header.tpl -->
    ...
    <div id="slider2_container" style="position: absolute; top: 40px; left: 20px; width: 1260px;
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; right: 90px; top: -20px; width: 803px; height: 540px;
            overflow: hidden; ">
            <!-- BEGIN directory_promo -->
            <div>
                <img u=image src="{T_IMAGESET_PATH}/directory/600x400/{directory_promo.S_IMAGE}"/>
