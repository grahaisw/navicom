<!-- INCLUDE header.tpl -->
    ...
    <div id="slider2_container" style="position: absolute; top: 0; left: 0px; width: 1280px; 
        ...
        <!-- Slides Container -->
       <div u="slides" style="cursor: move; position: absolute; left: -20px; top: 0px; width: 1280px; height: 720px;overflow: hidden; background: #000;">
            <!-- BEGIN directory -->
            <div>
                <img u=image src="{T_MEDIA_IMAGES_PATH}directories/contactus/{directory.S_IMAGE}"/>
