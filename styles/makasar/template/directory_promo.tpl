<!-- INCLUDE header.tpl -->
    ...
    <div id="slider2_container" style="position: absolute; top: 40px; right: 20px; width: 1250px; 
       ...
       <div u="slides" style="cursor: move; position: absolute; right: 42px; top: -20px; width: 803px; height: 540px;
            ...
            <div>
                <img u=image src="{T_MEDIA_IMAGE_PATH}800x485/{directory_promo.S_IMAGE}"/>
                <div u="thumb"><h2><!--{directory_promo.S_TITLE}--></h2>
		    <span class="sub_container"><!--{directory_promo.S_CONTENT}--><span>
                </div>
            </div>
            <!-- END directory_promo -->
