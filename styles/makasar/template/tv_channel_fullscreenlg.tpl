...
<input type="hidden" id="gid" value="{S_GID}" />
...
<div id="divLogo"><img src="{T_IMAGESET_PATH}/logo-small.png" height="85px"></div>-->
<!-- begin menu -->
<!-- <div id="apDiv5" style="text-align:center"> -->
<!--<div id="divLeftArrow">
	<img src="{T_IMAGESET_PATH}/left.png" /><br/>
</div>
...
<div id="divRightArrow">
	<img src="{T_IMAGESET_PATH}/right.png" /><br/>
</div>
