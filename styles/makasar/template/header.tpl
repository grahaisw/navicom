...
<link href="{T_THEME_PATH}/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
...
<style type="text/css">
  body{ background:#000 url({T_MEDIA_IMAGES_PATH}bground/{S_BGROUND_CH}) no-repeat center top; } 
  #divWidget{display:none}
</style>
...
<script type="text/javascript">
	...
	["{music.S_TITLE}", //0
	"{music.S_TRAILER}", //1
	"{music.S_DESCRIPTION}", //2 
	0, //3
	"{T_MEDIA_IMAGE_music_PATH}160x160/{music.S_THUMBNAIL}.png", //4
	"{T_MEDIA_IMAGE_music_PATH}200x280/{music.S_THUMBNAIL}.jpg",  //5
	"{music.S_ID}", //6
	// "{music.'S_FULL_music}",
	"{music.L_DIRECTOR}", //7
	"{music.S_DIRECTOR}", //8
...
<style type="text/css">
    body {
	background: #000 url({T_MEDIA_IMAGES_PATH}remote/{S_LANG}/bground-remote.jpg) no-repeat top; 
	font-family: navicom-normal, jp, cn, kr;
	margin: 0px;
	padding: 0px;
	overflow: hidden;
...
<script src="{T_THEME_PATH}/welcome.js" type="text/javascript"></script> 
<script src="{T_THEME_PATH}/welcome_config_document.js" type="text/javascript"></script> 
<script type="text/javascript">
    window.onload = function () {
	//media._object.Fn_Play_Pause();
	/*media._object.Fn_Right_KeyDownHandler();
...
<!-- IF S_WI -->
<link href="{T_THEME_PATH}/wi.css" rel="stylesheet" type="text/css" />
<script src="{T_THEME_PATH}/hcap.js" type="text/javascript"></script>
<script src="{T_THEME_PATH}/log.js" type="text/javascript"></script>
<script>
var param = {
...
<style type="text/css">
  /*body{ background: #000 url({T_MEDIA_IMAGES_PATH}/bground/bground-welcome1.jpg) no-repeat center top; }*/
  #divWidget{display:none}
</style>
<!-- ENDIF -->
...
<!-- IF S_WHATSON -->
<!--<link href="{T_THEME_PATH}/whatson.css" rel="stylesheet" type="text/css" />-->
<script src="{T_THEME_PATH}/hcap.js" type="text/javascript"></script>
<script src="{T_THEME_PATH}/log.js" type="text/javascript"></script>
<script>
var param = {
...
<style type="text/css" media="screen">
body {
    background: #fff url({T_MEDIA_IMAGES_PATH}/bground/bground-group.jpg) no-repeat;
    font-family: navicom-normal, jp, cn, kr;
    margin: 0px;
    padding: 0px;
    overflow: hidden;
...
<div id="divWidget">
	<div id="divWeather">
		...
		<img src="{T_MEDIA_IMAGES_PATH}#divWidget{display: none;}/256x256/{S_WIDGET_ICON}.png" width="60" style="margin:-17px 0 0 3px;" />
