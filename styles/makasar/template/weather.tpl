<!-- INCLUDE header.tpl -->
    ...
    <script type="text/javascript" src="{T_THEME_PATH}/_jquery-1.9.1.min.js"></script>
 ...
 <div id="divVideoContainer" class="divVideoContainer">
    ...
    <div id="slider2_container" style="position: absolute; top: 0px; right: 20px; width: 100%; 
       ...
       <div u="slides" style="cursor: move; position: absolute; left: 20px; top: 85px; width: 450px; height: 635px;
            ...
            <!-- BEGIN forecast -->
            <div>
                <img u=image src="{T_MEDIA_IMAGES_PATH}/cities/450x720/{forecast.S_CITY_SIGNATURE}.jpg" />
                <div u="thumb"><h2>{directory.S_TITLE} {forecast.L_TODAY}</h2>
		    <span class="today">
		      <img src="{T_MEDIA_IMAGES_PATH}/weathers/256x256/{forecast.S_WEATHER_TODAY}.png" width="220px"/>
		      <br/>
			<font color="red">{forecast.S_TODAY_TEMPC_H}°C</font> - <font color="blue">{forecast.S_TODAY_TEMPC_L}°C</font>
		    </span>
		    <span class="forecast">
			<span class="forecast1">
			    <strong>{L_FORECAST_DAY1}</strong>
			    <img class="weather_icon" src="{T_MEDIA_IMAGES_PATH}/weathers/256x256/{forecast.S_FORECAST1_WEATHER}.png">
			    <span class="temp"><font color="red">{forecast.S_FORECAST1_TEMPC_H}°C</font> - <font color="blue">{forecast.S_FORECAST1_TEMPC_L}°C</font></span>
			</span>
			<span class="forecast2">
			    <strong>{L_FORECAST_DAY2}</strong>
			    <img class="weather_icon" src="{T_MEDIA_IMAGES_PATH}/weathers/256x256/{forecast.S_FORECAST2_WEATHER}.png">
			    <span class="temp"><font color="red">{forecast.S_FORECAST2_TEMPC_H}°C</font> - <font color="blue">{forecast.S_FORECAST2_TEMPC_L}°C</font></span>
			</span>
			<span class="forecast3">
			    <strong>{L_FORECAST_DAY3}</strong>
			    <img class="weather_icon" src="{T_MEDIA_IMAGES_PATH}/weathers/256x256/{forecast.S_FORECAST3_WEATHER}.png">
			    <span class="temp"><font color="red">{forecast.S_FORECAST3_TEMPC_H}°C</font> - <font color="blue">{forecast.S_FORECAST3_TEMPC_L}°C</font></span>
			</span>
		    <span>
                </div>
            </div>
