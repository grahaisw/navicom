...
<style type="text/css">
  body{ background: #fff url({T_MEDIA_IMAGES_PATH}/bground/{S_BGROUND_IMAGE}) no-repeat center top; } 
</style>
...
<style type="text/css">
  body{ background:#000 url({T_MEDIA_IMAGES_PATH}/bground/{S_BGROUND_IMAGE}) no-repeat center top; } 
</style>
<!-- ENDIF -->
...
<script type="text/javascript">
    var channelListArray = [  
	<!-- BEGIN channel -->
	["{channel.S_TITLE}", "{channel.S_URL}","{T_MEDIA_IMAGE_TV_PATH}160x160/{channel.S_THUMBNAIL}", 0],
	<!-- END channel -->
    ];
</script>
<!--
...
<style type="text/css">
  body { 
      background: #fff url({T_MEDIA_IMAGES_PATH}/bground/{S_BGROUND_IMAGE}) no-repeat center top; 
      margin: 0px;
      padding: 0px;
  } 
</style>
...
<style type="text/css">
  body{ 
      background: #000 url({T_MEDIA_IMAGES_PATH}/bground/{S_BGROUND_IMAGE}) no-repeat center top; 
      margin: 0px;
      padding: 0px;
      } 
</style>
...
<div id="nonemergency">
	...
	<div id="divLogo"><img src="{T_IMAGESET_PATH}/logo.jpg" height="85px"></div>
