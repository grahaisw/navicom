...
mediaPlayer.prototype.Fn_ChannelListDataBind = function (val) {
    for (var i = 0; i < media.channelObjlen; i++) {
        if (channelListArray[i + val] != undefined) {
            $(media.channelListObject[i]).attr("cItem", (i + val)).html("<span class='spanChannlItem'>" + channelListArray[i + val][0] + "</span><span class='spanChannlItem2'>" + channelListArray[i + val][1] + "</span><span class='spanChannlItem3'>" + channelListArray[i + val][2] + "</span><span class='spanChannlItem4'>" + channelListArray[i + val][4] + "</span><span class='spanChannlItem5'>" + channelListArray[i][5] + channelListArray[i + val][6] + "</span><span class='spanChannlItem6'>" + channelListArray[i + val][7] + "</span>");
        } else {
