...
<div id="divChannelListHeader">{S_GROUP_TITLE}</div>
...
<input type="hidden" id="ch_index" name="ch_index" value="{S_GUEST_LAST_CHANNEL}" />
<input type="hidden" id="mode" name="mode" value="nonfullscreen" />
<input type="hidden" id="verify_password" name="verify_password" value="{S_TV_CHANNEL_VERIFIED}" />
...
<input type="hidden" id="index_category" name="index_category" value="{S_GID}" />
...
<!-- fullscreen start-->
<!--<div id="divLogo"><img src="{T_IMAGESET_PATH}/sh.png" height="130px"></div>-->
...
<div id="divChannelScrambled" class="displayNone">
    <div id="divChannelScrambledMessage">{L_SCRAMBLED_MESSAGE}<div id="divCsContact">{L_CS_CONTACT}</div></div>    
</div>
...
<div id="divParentalLock" class="displayNone">
	<h1><div id="divTitle" style="width:100%; text-align:center; color:#000;">{L_ENTER_PASSWORD}</div></h1>
	<div>
...
<!--<div id="logoPlay" class="displayNone">
     <img src="{T_IMAGESET_PATH}/logo-play.png"/>
</div>-->
<!-- fullscreen end -->
