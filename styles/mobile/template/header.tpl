...
<head>
	...
	<link href="{T_THEME_PATH}/style-menu.css" rel="stylesheet">
	...
	<script type="text/javascript" src="{T_THEME_PATH}/jssor.utils.js"></script>
	<script type="text/javascript" src="{T_THEME_PATH}/jssor.slider.js"></script>
	<script type="text/javascript" src="{T_THEME_PATH}/jquery.fancybox.js"></script>
...
<body id="body">
	...
	<div id="menu-wrapper">
		<ul class="sidebar-nav ">
			<!-- BEGIN menu -->
			<li>
				<a href="{menu.S_MENU_URL}">{menu.S_MENU_TITLE}</a>
			</li>
			<!-- END menu -->
		</ul>
	</div>
