...
<!-- main container -->
    ...
    <div style="position: relative; width: 100%; background-color: #101010; overflow: hidden;">
        <div style="position: relative; left: 50%; width: 5000px; text-align: center; margin-left: -2500px;">
            <!-- Jssor Slider Begin -->
            <div id="slider1_container" style="position: relative; margin: 0 auto;
                top: 0px; left: 0px; width: 980px; height: 400px; background-color: #000;">
                    ...
                    <div>
                        <div style="position: absolute; width: 360px; height: 300px; top: 10px; left: 10px;
                            ...
                            <span style="display: block; line-height: 1em; text-transform: uppercase; font-size: 22px;
                                color: #FFFFFF;">{roomservice.S_TITLE}</span>
                            <br />
							<span style="display: block; line-height: 1.1em; font-size: 16px; color: #FFFFFF;">{roomservice.S_DESCRIPTION}</span>
                            <br />
                            <br />
							<div style="position:absolute;top:350px;font-size: 16px; color: #FFFFFF;width:100%">
								<div style="display:inline-block;">{roomservice.L_CURRENCY}&nbsp;&nbsp;{roomservice.S_PRICE}</div>
								<div style="display:inline-block;position:absolute;right:10px;width:120px;border:1px solid #fff;text-align:center;cursor:pointer;color:#fff;"><a class="fancybox fancybox.iframe" href="roomservice_confirm.php?{roomservice.S_KEY}code={roomservice.S_CODE}&qty={roomservice.S_QTY}&item_id={roomservice.S_SERVICE_ID}&price={roomservice.S_PRICE}&gid={roomservice.S_GID}&mode={roomservice.S_MODE}">{L_CALL_TO_ORDER}</a></div>
							</div>
                        </div>
                        <img src="{T_MEDIA_IMAGES_PATH}/fnb/600x400/{roomservice.S_THUMBNAIL}.jpg" style="position: absolute; top: 0px; left: 380px; width: 600px; height: 400px;" />
                        <img u="thumb" src="{T_MEDIA_IMAGES_PATH}/fnb/600x400/{roomservice.S_THUMBNAIL}.jpg" />
                    </div>
