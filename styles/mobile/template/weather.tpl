                    ...
                    <div>
                        <div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;
                            ...
                            <span style="display: block; line-height: 1em; text-transform: uppercase; font-size: 36px;
                                color: #FFFFFF;">{forecast.S_CITY}</span>
                            <br />
                            <br />
                            <span style="display: block; line-height: 1.1em; font-size: 2.5em; color: #FFFFFF;">{forecast.L_TODAY}</span>
                            <br />
                            <span style="display: block; line-height: 1.1em; font-size: 1.5em; color: #FFFFFF;"><img src="{T_IMAGESET_PATH}/weather/256x256/{forecast.S_WEATHER_TODAY}.png" width="180px"/>
                            <font color="red">{forecast.S_TODAY_TEMPC_H}°C</font> - <font color="blue">{forecast.S_TODAY_TEMPC_L}°C</font>
                            </span>
                            <br />
                            <br />
                        </div>
                        <img src="{T_IMAGESET_PATH}/city/600x400/{forecast.S_CITY_SIGNATURE}.jpg" style="position: absolute; top: 0px; left: 380px; width: 600px; height: 400px;" />
                        <img u="thumb" src="{T_IMAGESET_PATH}/city/600x400/{forecast.S_CITY_SIGNATURE}.jpg" />
                    </div>
