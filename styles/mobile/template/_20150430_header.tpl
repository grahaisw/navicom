...
<body id="body">
    ...
    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="b-menu-1">
	      ...
	      <!-- END menu -->
		  <!-- IF S_MORE -->
		  <li class="active sb-open-right sb-close"><a href="#"><img src="{T_IMAGESET_PATH}/more.png"></a></li>
		  <!-- ENDIF -->
          </ul>
        </div> <!-- /.nav-collapse -->
    ...
    <div class="sb-slidebar sb-right sb-momentum-scrolling">
		<ul>
			<!-- BEGIN menu_more -->
			<li><a href="{menu_more.S_MENU_URL}"><img src="{T_IMAGESET_PATH}/60x60/{menu_more.S_MENU_THUMBNAIL}"></a></li>
			<!-- END menu_more -->
