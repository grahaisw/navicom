...
<table style="font-size: 14px; padding: 10px;">
    <tr>
	<td width="30%" align="right">{L_PASSWORD}</td>
	<td width="70%"><input type="password" id="password" name="password" placeholder="{L_PASSWORD}" autofocus size="20"/></td>
    </tr>
    <tr>
	...
	<td><textarea id="info" name="note" rows="1" cols="30" style="width: 280px; height: 60px; resize: none;" placeholder="{L_SPECIAL_REQUEST}" >{S_NOTE}</textarea>
	</td>
    </tr>
    <tr>
...
<textarea id="info" name="note" rows="1" cols="30" style="width: 730px; height: 91px; resize: none;" placeholder="{L_SPECIAL_REQUEST}" ></textarea>
