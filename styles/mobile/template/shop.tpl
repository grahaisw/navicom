...
<!-- main container -->
    ...
    <div style="position: relative; width: 100%; background-color: #441110; overflow: hidden;">
        <div style="position: relative; left: 50%; width: 5000px; text-align: center; margin-left: -2500px;">
            <!-- Jssor Slider Begin -->
            <div id="slider1_container" style="position: relative; margin: 0 auto;
                top: 0px; left: 0px; width: 980px; height: 400px; background-color: #350D0C;">
                    ...
                    <div>
                        <div style="position: absolute; width: 360px; height: 300px; top: 10px; left: 10px;
                            ...
                            <span style="display: block; line-height: 1em; text-transform: uppercase; font-size: 22px;
                                color: #FFFFFF;">{shop.S_TITLE}</span>
                            <br />
							<span style="display: block; line-height: 1.1em; font-size: 16px; color: #FFFFFF;">{shop.S_DESCRIPTION}</span>
                            <br />
                            <br />
							<div style="position:absolute;top:350px;font-size: 16px; color: #FFFFFF;width:100%">
								<div style="display:inline-block;">{shop.L_CURRENCY}&nbsp;&nbsp;{shop.S_PRICE}</div>
								<div style="display:inline-block;position:absolute;right:10px;width:150px;border:1px solid #fff;text-align:center;cursor:pointer;color:#fff;"><a class="fancybox fancybox.iframe" href="shop_confirm.php?{shop.S_KEY}code={shop.S_CODE}&qty={shop.S_QTY}&item_id={shop.S_SERVICE_ID}&price={shop.S_PRICE}&gid={shop.S_GID}&mode={shop.S_MODE}&title={shop.S_TITLE}">{L_CALL_TO_ORDER}</a></div>
							</div>
                        </div>
                        <img src="{T_MEDIA_IMAGES_PATH}/shop/600x400/{shop.S_THUMBNAIL}.jpg" style="position: absolute; top: 0px; left: 380px; width: 600px; height: 400px;" />
                        <img u="thumb" src="{T_MEDIA_IMAGES_PATH}/shop/600x400/{shop.S_THUMBNAIL}.jpg" />
                    </div>
