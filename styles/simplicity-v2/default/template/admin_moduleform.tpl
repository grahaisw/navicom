<!-- INCLUDE admin_header.tpl -->
	...
	<tr>
	    ...
	    <td><input name="order" type="text" id="order" value="{S_ORDER}" maxlength="2" /></td>
	</tr>
	<tr>
	    <td><label for="in_admin">{L_IN_ADMIN}:</label></td>
	    <td><input id="in_admin" name="in_admin_flag" type="checkbox" class="radio" {V_IN_ADMIN}/><label>&nbsp;</label></td>
	</tr>
	<tr>
