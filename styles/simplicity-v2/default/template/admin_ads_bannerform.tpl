<!-- INCLUDE admin_header.tpl -->
			...
			<tr>
			    ...
			    <td><input id="image" name="image" type="text" value="{S_IMAGE}" size="40"/><div id="file-uploader-demo1" style="width:100px; display:inline-block; vertical-align:top; line-height:18px; margin-left:5px;"></div>&nbsp;(height: 150 pixel, format: jpg/png/gif)</td>
			</tr>
			<tr>
