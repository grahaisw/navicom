...
<style type="text/css">
			...
			<table cellspacing="1">
			<input type="hidden" name="time" value="{L_ADDRESS}">
			<tr>
			    <td width="15%"><label>Start:</label></td>
			    <td width="85%"><input type="text" name="start" id="startdatetime" value="{S_START}" size="40"/>
			    </td>
			</tr>

			<tr>
			    <td width="15%"><label>End:</label></td>
			    <td width="85%"><input type="text" name="end" id="enddatetime" value="{S_END}" size="40"/>
			    </td>
			</tr>

			<tr>
			    <td width="15%"><label>Popup:</label></td>
			    <td width="85%">{S_TARGET_ZONE}
			    </td>
			</tr>

			<tr>
			    <td width="15%"><label>Duration:</label></td>
			    <td width="85%"><input type="text" name="duration" placeholder="Second" value="{S_DUR}" size="5"/>
			    </td>
			</tr>

			<tr>
			    <td width="15%"><label>Zone:</label></td>
			    <td width="85%">{S_TARGET_ROOM}
			    </td>
			</tr>

			<tr>
			    <td width="15%"><label>Channel:</label></td>
			    <td width="85%">{S_TARGET_CHANNEL}
			    </td>
			</tr>
