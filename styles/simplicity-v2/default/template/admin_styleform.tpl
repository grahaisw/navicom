<!-- INCLUDE admin_header.tpl -->
	...
	<tr>
	    <td><label for="type">{L_TYPE}:</label></td>
	    <td><input id="type" name="type_flag" type="checkbox" class="radio" {V_TYPE}/><label>&nbsp;</label></td>
	</tr>
	<tr>
	    <td><label for="active">{L_ACTIVE}:</label></td>
	    <td><input id="active" name="active_flag" type="checkbox" class="radio" {V_ACTIVE}/><label>&nbsp;</label></td>
	</tr>
	<tr>
	    <td>&nbsp;</td>
