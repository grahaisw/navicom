...
<style type="text/css">
    ...
    <div id="main">
			...
			<!-- IF S_SUBSCRIBER_LOG -->
			<span class="xls" style="float: right;"><a href="#" onclick="exportXLS('ads_banner_log');">Export Detail  </a></span>
			<!-- ELSE -->
			<span  class="xls" style="float: right;"><a href="#" onclick="alllog('all_log');">Export Detail  </a></span>
			<!-- ENDIF -->
