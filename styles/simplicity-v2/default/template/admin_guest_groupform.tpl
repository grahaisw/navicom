...
$(function() {
    $('#DeleteLink').click(function() {
		...
		<!-- IF S_FORM -->
			...
			<table cellspacing="1">
			<tr>
			    <td width="15%"><label>{L_CODE}:</label></td>
			    <td width="85%"><input name="code" type="text" value="{S_CODE}"/></td>
			</tr>
			<tr>
			    <td><label>{L_NAME}:</label></td>
			    <td><input type="text" name="name" value="{S_NAME}" size="69"></td>
			</tr>
			<tr>
		...
		<!-- IF S_DETAIL -->
			...
			<tr>
			    <td width="15%"><label>{L_CODE}:</label></td>
			    <td width="85%"><label>{S_CODE}</label></td>
			</tr>
			<tr>
			    <td><label>{L_NAME}:</label></td>
