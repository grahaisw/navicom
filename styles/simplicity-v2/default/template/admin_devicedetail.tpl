<!-- INCLUDE admin_header.tpl -->
	...
	<tr>
	    <td><label for="file">{L_DEVICE_ID}</label></td>
	    <td><input name="device" type="text" id="file" value="{S_DEVICE}" /></td>
	</tr>
	
	<tr>
	    <td><label for="node_id">{L_NODE}</label></td>
	    <td>{S_CATEGORY}</td>
	</tr>
	<tr>
	    <td><label for="enabled">{L_DEVICE_ON}</label></td>
	    <td><input id="status" name="status" type="checkbox" class="radio" {V_STATUS}/><label>&nbsp;</label></td>
	</tr>
	<tr>
