...
<input type="hidden" id="region2_type" value="{S_TYPE_2}" />

<input type="hidden" id="region2_header" value="{S_HEADER_2}" />

<input type="hidden" id="region3_type" value="{S_TYPE_3}" />

<input type="hidden" id="region3_header" value="{S_HEADER_3}" />

<input type="hidden" id="region4_type" value="{S_TYPE_4}" />

<input type="hidden" id="region4_header" value="{S_HEADER_4}" />

<input type="hidden" id="region5_type" value="{S_TYPE_5}" />

<input type="hidden" id="region5_header" value="{S_HEADER_5}" />
...
<div id="nonrunningtext">
    ...
    <div id="region2">
        ...
        <input type="hidden" id="region2_content" value="{S_CONTENT_2}" />

        <input type="hidden" id="region2_content_duration" value="{S_DURATION_2}" />
    ...
    <div id="region3">
        ...
        <input type="hidden" id="region3_content" value="{S_CONTENT_3}" />

        <input type="hidden" id="region3_content_duration" value="{S_DURATION_3}" />
    ...
    <div id="region4">
        ...
        <input type="hidden" id="region4_content" value="{S_CONTENT_4}" />

        <input type="hidden" id="region4_content_duration" value="{S_DURATION_4}" />
        ...
        <!--<p><marquee scrollamount="3" loop="" scrolldelay="3" direction="up" style="height:100%">{S_CONTENT_4}</marquee></p>-->
