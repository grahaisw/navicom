...
*
* @package dbal
* @note currently not used, but may be utilized later.
*/
class tonjaw_db_tools
{
	/**
	* Current sql layer
	*/
	...
	*
	* @param tonjaw_dbal	$db					DBAL object
	* @param bool		$return_statements	True if only statements should be returned and no SQL being executed
	*/
	function tonjaw_db_tools(&$db, $return_statements = false)
	{
		$this->db = $db;
