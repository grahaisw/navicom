...
class dbal_mssqlnative extends dbal
{
	...
	*/
	function sql_connect($sqlserver, $sqluser, $sqlpassword, $database, $port = false, $persistency = false, $new_link = false)
	{
		...
		{
			$this->connect_error = 'Native MS SQL Server driver for PHP is missing or needs to be updated. You can download the driver from: http://www.microsoft.com/sqlserver/2005/en/us/PHP-Driver.aspx';
