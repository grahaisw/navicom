...
class utf_normalizer
{
	...
	*/
	function cleanup(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfc_qc']))
		{
			...
			include($tonjaw_root_path . $config['include_path'] . 'utf/data/utf_nfc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			global $tonjaw_root_path, $phpEx;
			include($tonjaw_root_path . $config['include_path'] . 'utf/data/utf_canonical_decomp.' . $phpEx);
		}
	...
	*/
	function nfkc(&$str)
	{
		...
		{
			global $tonjaw_root_path, $phpEx;
			include($tonjaw_root_path . $config['include_path'] . 'utf/data/utf_nfkc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{
			global $tonjaw_root_path, $phpEx;
			include($tonjaw_root_path . 'utf/data/utf_compatibility_decomp.' . $phpEx);
		}
	...
	*/
	function nfkd(&$str)
	{
		...
		{
			global $tonjaw_root_path, $phpEx;
			include($tonjaw_root_path . $config['include_path'] . 'utf/data/utf_compatibility_decomp.' . $phpEx);
		}
	...
	*/
	...
	{
		global $utf_combining_class, $utf_canonical_comp, $utf_jamo_type, $utf_jamo_index, $config;

		// Load some commonly-used tables
		if (!isset($utf_jamo_index, $utf_jamo_type, $utf_combining_class))
		{
			global $tonjaw_root_path, $phpEx;
			include($tonjaw_root_path . $config['include_path'] . 'utf/data/utf_normalizer_common.' . $phpEx);
		}
		...
		{
			global $tonjaw_root_path, $phpEx;
			include($tonjaw_root_path . $config['include_path'] . 'utf/data/utf_canonical_comp.' . $phpEx);
		}
...
//						}
	...
	*/
	...
	{
		global $utf_combining_class, $config;
