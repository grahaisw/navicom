...
function initShutDownWindow(){
	var box = $('<div align="center" style="position:absolute;top:200px;left:400px;opacity:1;" id="shutDownWindow"></div>');
	$('body').append(box);
...
function initBackWindow(){
	var box = $('<div align="center" style="position:relative;left:400px;" id="shutDownWindow"></div>');
	$('body').append(box);
	...
	jQuery.extend({ 
		...
		,SetVideoWin:function(left,top,scaler,type){	//设置缩放
			if(_isAli){
                ...
                //left = 0; top = 100; width = 780; height = 500;
