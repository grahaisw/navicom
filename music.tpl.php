...
<div id="divCurrentChannelNameContainer" style="font-family: <?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>;">
    <div id="divCurrentChannelName" style="font-family: <?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>;"></div>
    <div id="divGenre" style="font-family: <?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>;"></div>
</div>
...
<div id="divControlContainer">
	...
	<?php echo ((isset($this->_rootref['L_BUY_TO_WATCH'])) ? $this->_rootref['L_BUY_TO_WATCH'] : ((isset($user->lang['BUY_TO_WATCH'])) ? $user->lang['BUY_TO_WATCH'] : '{ BUY_TO_WATCH }')); ?>
