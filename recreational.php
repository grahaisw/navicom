...
$sql = "SELECT d.recreationals_image, d.recreationals_image_enabled, d.recreationals_clip, d.recreationals_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . RECREATIONALS_TABLE . " d 
    JOIN " . RECREATIONAL_TRANSLATIONS_TABLE . " t ON t.recreationals_id = d.recreationals_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.recreationals_enabled = 1  
    ORDER BY d.recreationals_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['recreationals_image'],
	'image_enable'	=> $row['recreationals_image_enabled'],
	'clip'			=> $row['recreationals_clip'],
	'clip_enable'	=> $row['recreationals_clip_enabled'],
	'title'			=> $row['title'],
