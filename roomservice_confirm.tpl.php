...
<table style="font-size: 20px; padding: 10px;">
    <!--<tr>
	<td width="30%" align="right" autofocus><?php echo ((isset($this->_rootref['L_PASSWORD'])) ? $this->_rootref['L_PASSWORD'] : ((isset($user->lang['PASSWORD'])) ? $user->lang['PASSWORD'] : '{ PASSWORD }')); ?></td>
	<td width="70%"><input type="password" id="password" name="password" autofocus="true" placeholder="<?php echo ((isset($this->_rootref['L_PASSWORD'])) ? $this->_rootref['L_PASSWORD'] : ((isset($user->lang['PASSWORD'])) ? $user->lang['PASSWORD'] : '{ PASSWORD }')); ?>" size="20"/></td>
    </tr>-->
    <tr>
...
<textarea id="info" name="note" type="text" rows="1" cols="30" style="width: 730px; height: 91px; resize: none;" placeholder="<?php echo ((isset($this->_rootref['L_SPECIAL_REQUEST'])) ? $this->_rootref['L_SPECIAL_REQUEST'] : ((isset($user->lang['SPECIAL_REQUEST'])) ? $user->lang['SPECIAL_REQUEST'] : '{ SPECIAL_REQUEST }')); ?>" ></textarea>
