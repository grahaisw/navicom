...
$sql = "SELECT d.directory2_image, d.directory2_image_enabled, d.directory2_clip, d.directory2_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . DIRECTORIES2_TABLE . " d 
    JOIN " . DIRECTORY2_TRANSLATIONS_TABLE . " t ON t.directory2_id = d.directory2_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.directory2_enabled = 1  
    ORDER BY d.directory2_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'image_enable'		=> $row['directory2_image_enable'],
	'clip'			=> $row['directory2_clip'],
	'clip_enable'		=> $row['directory2_clip_enable'],
	'title'			=> $row['title'],
