...
$sql = "SELECT d.dinings_image, d.dinings_image_enabled, d.dinings_clip, d.dinings_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . DININGS_TABLE . " d 
    JOIN " . DINING_TRANSLATIONS_TABLE . " t ON t.dinings_id = d.dinings_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.dinings_enabled = 1  
    ORDER BY d.dinings_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['dinings_image'],
	'image_enable'	=> $row['dinings_image_enabled'],
	'clip'			=> $row['dinings_clip'],
	'clip_enable'	=> $row['dinings_clip_enabled'],
	'title'			=> $row['title'],
