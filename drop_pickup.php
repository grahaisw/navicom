...
$sql = "SELECT d.drop_pickups_image, d.drop_pickups_image_enabled, d.drop_pickups_clip, d.drop_pickups_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . DROP_PICKUPS_TABLE . " d 
    JOIN " . DROP_PICKUP_TRANSLATIONS_TABLE . " t ON t.drop_pickups_id = d.drop_pickups_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.drop_pickups_enabled = 1  
    ORDER BY d.drop_pickups_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['drop_pickups_image'],
	'image_enable'	=> $row['drop_pickups_image_enabled'],
	'clip'			=> $row['drop_pickups_clip'],
	'clip_enable'	=> $row['drop_pickups_clip_enabled'],
	'title'			=> $row['title'],
