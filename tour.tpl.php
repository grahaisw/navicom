...
<div id="divControlContainer">
	...
	<a id="divBasket" class="fancybox fancybox.iframe" style="font-family: <?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>;"><?php echo ((isset($this->_rootref['L_CALL_TO_ORDER'])) ? $this->_rootref['L_CALL_TO_ORDER'] : ((isset($user->lang['CALL_TO_ORDER'])) ? $user->lang['CALL_TO_ORDER'] : '{ CALL_TO_ORDER }')); ?></a>
</div>
