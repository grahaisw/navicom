...
$sql = "SELECT d.inhouses_image, d.inhouses_image_enabled, d.inhouses_clip, d.inhouses_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . INHOUSES_TABLE . " d 
    JOIN " . INHOUSE_TRANSLATIONS_TABLE . " t ON t.inhouses_id = d.inhouses_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.inhouses_enabled = 1  
    ORDER BY d.inhouses_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['inhouses_image'],
	'image_enable'	=> $row['inhouses_image_enabled'],
	'clip'			=> $row['inhouses_clip'],
	'clip_enable'	=> $row['inhouses_clip_enabled'],
	'title'			=> $row['title'],
