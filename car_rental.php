...
$sql = "SELECT d.car_rentals_image, d.car_rentals_image_enabled, d.car_rentals_clip, d.car_rentals_clip_enabled, 
	t.translation_title AS title, t.translation_description AS description  
    FROM " . CAR_RENTALS_TABLE . " d 
    JOIN " . CAR_RENTAL_TRANSLATIONS_TABLE . " t ON t.car_rentals_id = d.car_rentals_id 
    WHERE t.language_id= '" . $lang_id . "' AND d.car_rentals_enabled = 1  
    ORDER BY d.car_rentals_order";
...
while ($row = $db->sql_fetchrow($result))
{
	...
	'rec1'			=> $rec1,
	'image'			=> $row['car_rentals_image'],
	'image_enable'	=> $row['car_rentals_image_enabled'],
	'clip'			=> $row['car_rentals_clip'],
	'clip_enable'	=> $row['car_rentals_clip_enabled'],
	'title'			=> $row['title'],
